...
public class TodoItemRecord extends UpdatableRecordImpl<TodoItemRecord> implements Record4<Long, String, Boolean, Long> {

    private static final long serialVersionUID = 639085590;
     ...
     */
    @Override
    public TodoItemRecord values(Long value1, String value2, Boolean value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TodoItemRecord(Long id, String name, Boolean checked, Long createdBy) {
        super(TodoItem.TODO_ITEM);
