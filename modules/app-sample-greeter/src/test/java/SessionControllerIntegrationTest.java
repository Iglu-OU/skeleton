...
public class SessionControllerIntegrationTest {
    ...
    private String testUrl = "http://localhost:8080/greeter";
    ...
    public void testRedisControlsSession() {
        ...
        assertEquals("Hello, World from Pebble!", result.getBody()); // login worked
        ...
        assertEquals("Hello, World from Pebble!", result.getBody()); // access with session works worked
